...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  Target = new G4Tubs("Target",                                          //name
                      126 * mm,  132 * mm, 375 * mm, 0. * deg, 180. * deg); //dimensions
  ...
  Target1 = new G4Tubs("Target1",                                          //name
                      77.5 * mm,  78.5 * mm, 375 * mm, 0. * deg, 180. * deg); //dimensions
  ...
  G4VPhysicalVolume  *PEmpty = new G4PVPlacement(0,                         //no rotation
                                                 ...
                                                 0);*/
  /*G4Tubs* 
  Upper1 = new G4Tubs("Upper1",                                   //name
                    125. * mm , 175. * mm, 375 * mm, 0. * deg, 180. * deg); //dimensions


  G4LogicalVolume *LogicUpper1= new G4LogicalVolume(Upper1,           //shape
                                                   world_mat,              //material
                                                   "Upper1");                 //name
                               
  G4VPhysicalVolume  *PUpper1 = new G4PVPlacement(0,                         //no rotation
                                                 G4ThreeVector(),             //at (0,0,0)a
                                                 LogicEmpty,                //logical volume
                                                 "Upper1",                    //name
                                                 logicWorld,                 //mother  volume
 ...
 constexpr G4double r = 0.1*cm;   // radius of a sphere                                                                 
 constexpr G4double DMIN = 1*r;   // min distance between two spheres                                                  
 ...
 new G4PVPlacement(0, G4ThreeVector(), cyl_logical, "Cylinder", logicWorld,
  ...
  /*G4VisAttributes* red = new G4VisAttributes(G4Color(1.0, .0, .0, 1.0));
  red->SetVisibility(true);
  red->SetForceSolid(true);
  LogTarget->SetVisAttributes(red);*/
